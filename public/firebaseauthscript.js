 /**
        ...
        function handleSignUp() {
            ...
            firebase.auth().createUserWithEmailAndPassword(email, password).catch(function(error) {
                ...
                messageAlertRegister.innerHTML = "<strong>Успешно!</strong> создана Ваша учетная запись.";
        ...
        function initApp() {
            ...
            firebase.auth().onAuthStateChanged(function(user) {
                ...
                if (user) {
                    ...
                    var emailVerified = user.emailVerified; console.log('emalverifyed: '+emailVerified);
                    if(!emailVerified){
                            console.log('verify email send');
                            messageAlertAuth.className=('alert alert-danger');
                            messageAlertAuth.innerHTML = "Email :<strong>"+email+" не подтвержден!</strong> Проверьте почту и подтвердите email. ";
                            //sendEmailVerification();
                            return false;
                    };
                    ...
                    messageAlertAuth.innerHTML = "Здарвствуйте <strong>"+displayName+"</strong> ,Вы выполнили вход используя почту: "+"<strong>"+email+"</strong>";
